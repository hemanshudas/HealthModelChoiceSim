...
#### The code is an implementation of the microsimulation model to emulate individuals 
#### through state-level transitions with a varying death rate among healthy
