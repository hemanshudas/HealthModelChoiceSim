...
#### This is similar to DrugComparision_MicroSim.R to understand the model better
...
p.WEv <- 0.15
sim_drugA <- MicroSim(p.WEv,p.UD_A,c.U_A)
...
C_diff <- v.C[1]-v.C[2]
U_diff <- v.U[1]-v.U[2]
ICER <- C_diff/U_diff                             #Incremental Cost Effectiveness Ratio
